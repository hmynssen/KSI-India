...
data_folder="/mnt/d/DATA_India/STA21"
results_folder="/mnt/c/Users/Heitor Gessner/Documents/Metabio-Personal/KSI-India/results/STA21"
subj="STA21"
extract_brain="STA21.nii.gz"
full_label_mask="STA21_tissue.nii.gz"
...
fslmaths "${data_folder}/${extract_brain}" -mul "${data_folder}/${subj}_brain_mask.nii.gz" -bin "${data_folder}/${subj}_extracted_brain.nii.gz"
